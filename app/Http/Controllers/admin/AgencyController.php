...
class AgencyController extends Controller
{
	 ...
	 */
		...
		public function updateAgencyProfile(Request $request)
		{
				...
				if($request->file('agency_image')) {
					$agencyDetail->agency_image = CustomHelper::saveImageOnCloudanary($request->file('agency_image'),'AgencyProfileImage');
				}
	...
	public function uploadAgencyImage(Request $request)
	{
			...
			if (isset($check_image)){
				 $image = CustomHelper::saveImageOnCloudanary($image,'Certificates');
	...
	public function updateActivityBasicInfo(Request $request)
	{
		...
		if(isset($data['background_image'])){
			$activityDetail->background_image=CustomHelper::saveImageOnCloudanary($request->file('background_image'),'ActivityBackground');
		}
	...
	public function updateCampingPackage(Request $request)
	{
		...
		if(isset($data['background_image'])){
			$campingDetail->background_image=CustomHelper::saveImageOnCloudanary($request->file('background_image'),'CampingBackground');
		}
	...
	public function updateComboPackage(Request $request)
	{
			...
			if(isset($data['background_image'])){
				$comboDetail->background_image=CustomHelper::saveImageOnCloudanary($request->file('background_image'),'ComboBackground');
			}
