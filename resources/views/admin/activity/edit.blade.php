        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input required class="form-control placeholder-no-fix" type="text" placeholder="Activity Name" name="name" value="{{(isset($activityDetail) && !empty($activityDetail->name)) ? $activityDetail->name:''}}" />
              </div>
            </div>
          </div>
<!--          <div class="form-body">
