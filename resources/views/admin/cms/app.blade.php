                            ...
                            <div class="col-md-12">
                                <div class="form-body">
                                    ...
                                    <div class="col-sm-12 well">
                                        {!! Form::open(['route' => 'admin.update-cms-app','role'=>'form','method'=>'post']) !!}

                                        <textarea class="form-control" id="text" name="text"  rows="5">{{$pageDetail->content}}</textarea>
                                        <div class="clearfix"></div>
                                        <input type="hidden" value="{{$pageDetail->id}}" name="id" />

                                        <button style="float:right;margin-top:20px" class="btn btn-info" type="submit">@lang('sidebar.update')</button>
