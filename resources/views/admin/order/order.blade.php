                    ...
                    <form class="form-inline " id="search_frm" name="search_frm" method="get" action="">
                        ...
                        <div class="pull-right">
                            ...
                            <div class=" form-group">
                                ...
                                <a href="orders" style=" margin-bottom: 0px;margin-right: 0px;"  class="btn btn-default">@lang('user.Reset')</a>
                            </div>
...
<div id="myModal-23" class="modal fade in" role="dialog">
    ...
    <!--                        <tr>                        
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">@lang('user.close')</button>
            </div>
