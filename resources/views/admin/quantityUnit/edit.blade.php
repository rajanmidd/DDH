...
@section('title')
@lang('quantityUnit.update_quantity_unit')
@endsection
@section('content')
<!-- BEGIN CONTENT -->
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="javascript:void(0);">@lang('quantityUnit.update_quantity_unit')</a>
                </li>
            </ul>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3> @lang('quantityUnit.update_quantity_unit')</h3>
            </div>
        ...
        <div class="row">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-table"></i> @lang('quantityUnit.update_quantity_unit')
                    </div>
                </div>
                ...
                <div class="portlet-body flip-scroll">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="@lang('quantityUnit.name')" class="form-control" name="name" value="{{$Detail->name}}"  />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="status" class="form-control">
                                    ...
                                    <option value="0" @if($Detail['status']==0) selected @endif>Inactive</option>
