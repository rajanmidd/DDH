                           ...
                           <div class="row">
                              <div class="col-md-12 col-sm-12">
                                 <div class="portlet purple box">
                                    ...
                                    <div class="portlet-body">
                                       <div class="row">
                                          {!! Form::open(['route' => 'accept-reject-request','class'=>'form-horizontal form-row-seperated']) !!}
                                             <div class="form-body">
                                                <div class="form-group">
                                                   <label class="control-label col-md-3">@lang('order.comment')</label>
                                                   <div class="col-md-9">
                                                      <textarea name="comment" placeholder="Comment" rows="7" cols="90"></textarea>
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="form-actions">
                                                <div class="row">
                                                   <div class="col-md-offset-3 col-md-9">
                                                      <button name="order_status" type="submit" value="2" class="btn green">@lang('order.accept_request')</button>
                                                      <button name="order_status" type="submit" value="3" class="btn red">@lang('order.reject_request')</button>
                                                   </div>
                                                </div>
                                             </div>
