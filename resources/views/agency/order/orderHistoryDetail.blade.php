                           ...
                           <div class="row">
                              <div class="col-md-12 col-sm-12">
                                 <div class="portlet green box">
                                    <div class="portlet-title">
                                       <div class="caption">
                                          <i class="fa fa-cogs"></i>@lang('order.order_status')
                                       </div>
                                    </div>                                    
                                    <div class="portlet-body">
                                       @if($order_detail->order_status =='2' || $order_detail->order_status =='4' || $order_detail->order_status =='5')
                                          <?php 
                                          $order_status=array();
                                          ...
                                          <div class="row">
                                             <div class="form-group">
                                                <div class="col-md-4">
                                                   <h4 class="block text-center">
                                                      <input type="checkbox" name="accepted" value="2" data-order-id="{{$order_detail->id}}" class="update_status" <?php if(in_array('2',$order_status)){ echo "checked";} ?> <?php if(in_array('2',$order_status)){ echo "disabled";} ?> /> 
                                                      <span> @lang('order.accepted')</span>                                                      
                                                   </h4>
                                                   <h6 class="text-center">{{date('h:i A',strtotime($order_detail->accepted_on))}}</h6>
                                                </div>
                                                <div class="col-md-4">
                                                   <h4 class="block text-center">
                                                      <input type="checkbox" name="disptached" value="4" data-order-id="{{$order_detail->id}}" class="update_status" <?php if(in_array('4',$order_status)){ echo "checked";} ?> <?php if(in_array('4',$order_status)){ echo "disabled";} ?>/>
                                                      <span> @lang('order.dispatched')</span>
                                                   </h4>
                                                   <h6 class="text-center">
                                                      @if($order_detail->dispatched_on)
                                                         {{date('h:i A',strtotime($order_detail->dispatched_on))}}
                                                      @endif
                                                   </h6>
                                                </div>  
                                                <div class="col-md-4">
                                                   <h4 class="block text-center">
                                                      <input type="checkbox" name="delivered" value="5" data-order-id="{{$order_detail->id}}" class="update_status" <?php if(in_array('5',$order_status)){ echo "checked";} ?> <?php if(in_array('5',$order_status)){ echo "disabled";} ?> <?php if(!in_array('4',$order_status)){ echo "disabled";} ?> />
                                                      <span> @lang('order.delivered')</span>
                                                   </h4>
                                                   <h6 class="text-center">
                                                      @if($order_detail->delivered_on)
                                                         {{date('h:i A',strtotime($order_detail->delivered_on))}}
                                                      @endif
                                                   </h6>
                                                </div> 
                                             </div>
                                       ...
                                       @else
                                          <div class="form-group">
                                             <h4 class="block"><b>@lang('order.order_cancel_mode')</b></h4>
                                             <h4>
                                                @if($order_detail->order_cancel_status =='1')
                                                   @lang('order.by_user')
                                                @elseif($order_detail->order_cancel_status =='2')
                                                   @lang('order.by_pharmacy')
                                                @else
                                                   @lang('order.automatic')
                                                @endif
                                             </h4>
                                          </div>
                                       @endif                                          
...
<div id="loading" style="display:none;">
   <img id="loading-image" src="{{asset('css/loading-animation.gif')}}" alt="Loading..." />
</div>
@endsection