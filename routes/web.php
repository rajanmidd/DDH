...
Route::group(['prefix' => 'agency','namespace'=>'agency'], function () {
  ...
  Route::get('/blocked',['as'=>'agency.blocked','uses'=>'LoginController@accountBlocked']);
    ...
    Route::get('/notifications',['as'=>'notifications','uses'=>'DashboardController@notifications','middleware'=> 'checkstatus']);
    Route::get('/agency-logout',['as'=>'agency.logout','uses'=>'LoginController@logout']);

    /*** Profile routes ***/
    Route::get('/profile',['as'=>'profile','uses'=>'ProfileController@index','middleware'=> 'checkstatus']);
    Route::get('/view-profile',['as'=>'view-profile','uses'=>'ProfileController@viewProfile','middleware'=> 'checkstatus']);
    Route::patch('/profile',['as'=>'profile','uses'=>'ProfileController@update','middleware'=> 'checkstatus']);
    Route::get('/delete-agency-logo',['as'=>'agency.delete-agency-logo','uses'=>'ProfileController@deleteAgencyLogo','middleware'=> 'checkstatus']);
    /*** Profile routes ***/
...
Route::group(['prefix' => 'admin', 'namespace' => 'admin'], function () {
  ...
  Route::group(['middleware' => 'admin'], function () {
    ...
    Route::get('/activities', ['as' => 'admin.activities', 'uses' => 'DashboardController@getActivities']);
    /*** admin logout routes ***/
    /*** admin logout routes ***/
    ...
    Route::get('edit-agency-activity/{agencyId}/{id}', ['as' => 'admin.edit-agency-activity', 'uses' => 'AgencyController@editAgencyActivity']);
    Route::post('update-activity-basic-info',['as'=>'admin.update-activity-basic-info','uses'=>'AgencyController@updateActivityBasicInfo']);
    ...
    Route::get('list-combo-packages/{id}', ['as' => 'admin.list-combo-packages', 'uses' => 'AgencyController@listComboPackages']);
